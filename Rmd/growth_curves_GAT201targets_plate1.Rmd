...
```{r load_plate_4, fig.width = 5, fig.height = 3.75}
strain_df_4 <- tibble( 
...
```{r plot_plate_4_stat_summary, fig.width = 5, fig.height = 3.75}
plot_plate_4 <- 
...
```{r load_plate_5, fig.width = 5, fig.height = 3.75}
strain_df_5 <- tibble( 
...
```{r plot_plate_5_stat_summary, fig.width = 5, fig.height = 3.75}
plot_plate_5 <- 
...
```{r load_plate_6, fig.width = 5, fig.height = 3.75}
strain_df_6 <- tibble( 
...
```{r plot_plate_6_stat_summary, fig.width = 5, fig.height = 3.75}
plot_plate_6 <- 
