...
This plots the budding index (% of cells with buds) for cells with and without Gat201, in Cryptococcus wakeup conditions.

Data were collected by Liz Ballou in 2023 (add details here).
...
budding_index_plot <- 
  ...
  geom_point() +
  stat_summary(geom = "errorbar", fun.ymax = "mean", fun.ymin = "mean") + 
  scale_color_strain +
