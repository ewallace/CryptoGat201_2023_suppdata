...
Plate reader growth curves of  WT KN99-alpha and gat201∆ deletion mutant 003(Madhani) in RPMI and CO2 independent media.
...
CO2i_spline_plot <- 
  ggplot_growthcurve_spline(data_od = normalised_od_CO2i %>%
                              filter(!is.na(Strain)),
                            value_od = "OD_corrected_time",
                            limits_time = c(0,72),
                            limits_od = c(0, 2),
