...
RPMI_plot <- 
  ggplot_growthcurve_summary(data_od = normalisedOD_RPMI %>%
                               filter(!is.na(Strain)),
...
RPMI_spline_plot <- 
  ggplot_growthcurve_spline(data_od = normalisedOD_RPMI %>%
                              filter(!is.na(Strain)),
                            value_od = "OD_corrected_time",
                            limits_time = c(0,72),
                            limits_od = c(0, 0.1),
...
YPD_plot  <- 
  ggplot_growthcurve_summary(data_od = normalisedOD_YPD %>%
                               filter(!is.na(Strain)),
                             value_od = "OD_corrected_time",
                             limits_time = c(0,72),
                             limits_od = c(0, 0.9),
...
YPD_spline_plot <- 
  ggplot_growthcurve_spline(data_od = normalisedOD_YPD %>%
                              filter(!is.na(Strain)),
                            value_od = "OD_corrected_time",
                            limits_time = c(0,72),
                            limits_od = c(0, 0.9),
